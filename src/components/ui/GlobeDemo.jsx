...
export function GlobeDemo() {
  ...
  return (
    <div className="relative w-full max-w-sm sm:max-w-md md:max-w-lg lg:max-w-xl aspect-[1/1] mt-6">
      ...
      >
        <p className="text-sm  text-neutral-700 dark:text-neutral-200 max-w-md mx-auto">
